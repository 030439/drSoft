          ...
          <div class="card ">
            ...
            <div class="card-body" style="background-color: #f5f5f5">
              <div class="table-responsive" style="height: 350px;">
                <form class="pl-5 pr-5" action="add-opreration" method="post">
                  <div class="row">
                    <div class="col">
                      <label for="patient">Operation Name</label>
                      <input id="patient" name="name" type="text" class="form-control" placeholder="name" value="<?= value("name")?>">
                    ...
                    <div class="col">
                      ...
                      <input type="text" name="add-name" class="form-control" placeholder="Additional name" value="<?= value("add-name")?>">
                  ...
                  <div class="row mt-2">
                    <div class="col-6">
                      ...
                      <input id="patient" name="charges" type="number" class="form-control" placeholder="Rs" value="<?= value("charges")?>">
                      <?php if(isset($errors['charges'])):?><span style="margin-left:10px;color:red"><?= $errors["charges"];?></span><?php endif;?>
                    </div>
                 </div>
                 <div class="text-center">
                    <button type="submit" name="create" class="btn btn-success pl-5 mt-4 pr-5 text-center">Save</button>
                 </div>
                </form>
                      </div></div></div>
                      </div>
